...
public class QuestaoMatematica extends Questao{
    public QuestaoMatematica(long id, long provaId, String enunciado, String[] alternativas, char alternativaCorreta, int questaoNaProva, TipoQuestao tipoQuestao, Materia materia) {
